      ...
      <div className="relative z-10 min-h-screen bg-white/20 dark:bg-black/20 backdrop-blur-[2px] transition-all duration-500">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center mb-12 sm:mb-16">
            ...
            >
              <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-md rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-2xl border border-gray-200/50 dark:border-gray-700/50">
            ...
            >
              <div className="relative">
                ...
                />
                <div className="relative bg-white/90 dark:bg-gray-800/90 backdrop-blur-md rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-2xl border border-gray-200/50 dark:border-gray-700/50">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
              {features.map((feature, index) => (
                <motion.div
                  key={index}
                  className="group bg-white/90 dark:bg-gray-800/90 backdrop-blur-md rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-200/50 dark:border-gray-700/50"
          ...
          >
            <div className="bg-gradient-to-r from-yellow-400/90 to-orange-500/90 backdrop-blur-md rounded-2xl sm:rounded-3xl p-6 sm:p-8 text-white shadow-2xl border border-yellow-300/30">
              <motion.h3 
              ...
              <motion.a 
                ...
                whileTap={{ scale: 0.95 }}
              >
                <button className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-white/90 backdrop-blur-sm text-gray-900 font-bold rounded-xl hover:bg-white transition-all duration-300 shadow-lg hover:shadow-xl">
                  Join Us Today
                </button>
              </motion.a>
            </div>
